            ...
            {ui === 0 && (
              <>
                ...
                <div className="mainInfo">
                  ...
                  <p className="sub">He just created an account (like you). 👋</p>
                  <p className="sub">
                    <b>
                      When you create an account, you get 4 random cards ♠ ♦.
                    </b>
                  </p>
                  <p className="sub">
                  ...
                  <p className="sub">
                    Each card has 3 stats : <b>Health ❤️</b>, <b>Strength 💪</b>
                    , and <b>Intelligence ✏️</b>
                  </p>
            ...
            {ui === 1 && (
              <>
                ...
                <div className="mainInfo">
                  ...
                  <p className="sub">But like Takis, there's some spice 🌶️</p>
                  <p className="sub">
                    <b>
                  ...
                  <p className="sub">
                    <b>
                      To Prevent this, you can trade 🤝 your card for other
                      cards from
                    </b>
                  </p>
                  <p className="sub">
